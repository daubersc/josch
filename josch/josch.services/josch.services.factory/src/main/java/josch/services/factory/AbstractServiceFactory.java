...
import josch.services.comparison.web.WebComparisonService;
...
public abstract class AbstractServiceFactory {
    ...
    /**
     * Returns the implementation of a web comparison service. Note there is only one kind of
     * WebComparisonService as of now.
     *
     * @return A concrete implementation of the {@link IWebComparisonService}.
     */
    public static IWebComparisonService getComparisonService() {
        return new WebComparisonService();
    }
}
